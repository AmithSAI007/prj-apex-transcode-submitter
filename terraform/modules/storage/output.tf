...
output "transcoded_videos_bucket_name" {
  description = "The name of the Cloud Storage bucket where transcoded videos will be stored."
  value       = data.google_storage_bucket.apex_dev_gcs_transcoded_videos.name
}
